...
namespace CareerCloud.EntityFrameworkDataAccess
{
    public class CareerCloudContext : DbContext
    {
        ...
        {
            optionBuilder.UseSqlServer(@"Server=tcp:humber-server.database.windows.net,1433;Initial Catalog=JOB_PORTAL_DB;Persist Security Info=False;User ID=Haitham;Password=myPassword@123;");
            //base.OnConfiguring(optionBuilder);
        }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            //#region SystemCountryCode
            //modelBuilder.Entity<SystemCountryCodePoco>().Ignore(x => x.ApplicantWorkHistory);
            //#endregion
